...
export default function Home() {
  return (
    <main className="main flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div
        // -z-[1]
        // before:dark:opacity-0 调整透明度
        className="dark:text-white relative  flex flex-col place-items-center before:absolute 
      ...
      after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent
       before:dark:to-blue-700 before:dark:opacity-0 after:dark:from-sky-900 after:dark:via-[#0141ff] 
      ...
      >
        {/* <Image
          ...
          priority
        /> */}
        <div className="text-5xl font-semibold text-center">多吃米饭</div>
        <div className="text-2xl  text-center mt-4">
          前端技术站点汇总 本站使用Next.js+Material-UI+TailwindCss
        </div>
      </div>

      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left dark:text-white">
        <Link
          href="/home"
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            查找相关前端技术站点，包括React、Vue、Angular等
          </p>
        </Link>
